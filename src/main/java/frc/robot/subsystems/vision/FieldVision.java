...
import frc.robot.subsystems.vision.FieldVisionIO.PoseObservationType;
...
public class FieldVision extends SubsystemBase {
  ...
  public FieldVision(VisionConsumer consumer, FieldVisionIO... io) {
  ...
  public void periodic() {
    ...
    Logger.recordOutput(
        "FieldVision/Summary/RobotPosesAccepted", allRobotPosesAccepted.toArray(new Pose3d[0]));
    Logger.recordOutput(
        "FieldVision/Summary/RobotPosesRejected", allRobotPosesRejected.toArray(new Pose3d[0]));
  }
